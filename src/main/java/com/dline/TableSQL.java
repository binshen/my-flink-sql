...
public class TableSQL {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //2\. 读取score.csv
        DataSet<String> input = env.readTextFile("src/score.csv");
        input.print();
        ...
        Table queryResult = tableEnv.sqlQuery("select player, count(season) as num from score group by player order by num desc limit 5");
